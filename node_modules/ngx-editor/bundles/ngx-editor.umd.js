(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subject'), require('rxjs/add/operator/map'), require('@angular/common/http'), require('@angular/forms'), require('codemirror'), require('codemirror/mode/htmlmixed/htmlmixed.js'), require('ngx-bootstrap'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Subject', 'rxjs/add/operator/map', '@angular/common/http', '@angular/forms', 'codemirror', 'codemirror/mode/htmlmixed/htmlmixed.js', 'ngx-bootstrap', '@angular/common'], factory) :
	(factory((global['ngx-editor'] = {}),global.ng.core,global.Rx,global.Rx.Observable.prototype,global.ng.common.http,global.ng.forms,global.codemirror,null,global['ngx-bootstrap'],global.ng.common));
}(this, (function (exports,core,Subject,map,http,forms,codemirror,htmlmixed_js,ngxBootstrap,common) { 'use strict';
...
var CommandExecutorService =               (function () {
    function CommandExecutorService(_http, _messageService) {
        this._http = _http;
            ...
            if (deletedValue) {
                ...
                if (restored) {
                    if (this.isNumeric(fontSize)) {
                        var fontPx = '<span style="font-size: ' + fontSize + 'px;">' + deletedValue + '</spanp>';
                        this.insertHtml(fontPx);
                    }
                    else {
                        var font = '<span style="font-size: ' + fontSize + ';">' + deletedValue + '</span>';
...
var NgxEditorComponent =               (function () {
    ...
    NgxEditorComponent.prototype.monitorEditor = function (value) {
...
var NgxEditorToolbarComponent =               (function () {
    ...
    NgxEditorToolbarComponent.prototype.buildInsertImageForm = function () {
